...
LUA_SHA1 = get_hash(os.path.join(CWD, TRACKER_ID+'.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        wget_args = [
            ...
            '--connect-timeout', '1',
            '--tries', 'inf',
            '--domains', 'pagesperso-orange.fr,wanadoo.fr,orange.fr',
            '--span-hosts',
            '--waitretry', '30',
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://archiveteam.org/images/thumb/f/f3/Archive_team.png/235px-Archive_team.png" height="50px" title=""/>
        <h2>Pages Perso Orange <span class="links"><a href="https://pages.perso.orange.fr/">Website</a> &middot; <a href="http://tracker.archiveteam.org/pagespersoorange/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Pages Perso Orange">Wiki</a></span></h2>
        <p>Archiving Pages Perso Orange.</p>
    '''
)
